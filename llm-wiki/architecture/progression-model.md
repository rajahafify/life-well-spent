...
## Test Coverage
- `tests/specs/progression_model_test.gd`: XP award, linked quest completion, facility unlock once, inactive certification rejection, certification steps 1-3, Guild unlock, Forest endpoint objective, and game-over request.
