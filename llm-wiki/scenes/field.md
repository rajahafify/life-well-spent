...
- after `swordsman_certification`, Forest gateway no longer repeats the Guard block and instead shows the prototype endpoint copy: `The Forest path opens. To be continued.`
