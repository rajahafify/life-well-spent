...
- after `swordsman_certification`, Forest Guard and Forest gateway no longer repeat the Guard block, preserve the `enter_forest` objective, and show the prototype endpoint copy: `The Forest path opens. To be continued.`
...
Latest Field validation: Field scene specs included in the full suite. Full suite currently reports `348 tests, 348 passed, 0 failed`.
