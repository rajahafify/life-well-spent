...
- Swordsman Guild certification is playable after the Forest Guard checkpoint and ends at a `To be continued` Forest endpoint.
...
- Test baseline: `347 tests, 347 passed, 0 failed`.
