...
- Swordsman Guild certification is a three-step Guildmaster quest chain after the Forest Guard checkpoint, backed by real Field objectives: defeat 10 Slimes, gather 2 Bat Wings, then defeat 2 Rats before spending Life on each step.
- Final certification shows a rebirth panel, persists the Swordsman Guild unlock through `ProfileSystem`, and opens the first Forest endpoint scene.
...
- Test baseline: `392 tests, 392 passed, 0 failed`.
